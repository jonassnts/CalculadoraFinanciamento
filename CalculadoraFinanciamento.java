public public class CalculadoraFinanciamento {
    ...
    if (duracaoDoEmprestimo <= 0|| taxaDeJuros <= 0||){
      System.out.println("Erro! Você deve
fazer um empréstimo de carro válido.");
    }
      else if(valorDoCarro >= valorEntrada) {
        System.out.println("O carro pode ser pago
        integralmente.");
